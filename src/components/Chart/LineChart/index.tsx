  ...
  const renderLabel = (index: number, label: String, labelTextStyle: any) => {
    return (
      <View
        ...
        <Text style={[labelTextStyle, {textAlign: 'center', fontFamily:fonts['montserrat-regular'], color:colors['gray-natural'],fontSize:normalize(11)}]} numberOfLines={1}>
          {label || ''}
        </Text>
      </View>
    );
            ...
            return (
              <View key={index} style={[styles.horizBar, {width: totalWidth}, ]}>
                <View
                  ...
                  {!hideYAxisText ? (
                    //y axis lable style change here
                    <Text
                      numberOfLines={1}
                      ellipsizeMode={'clip'}
                      style={[
                        ...
                        },{fontFamily:fonts['montserrat-regular'], color:colors['gray-natural'],fontSize:normalize(11)}
                      ]}>
